...
class StateMappings {
  ...
  /// Maps abbreviations to full state names
  static const Map<String, String> abbrToName = {
    'AL': 'Alabama',
    'AK': 'Alaska',
    'AZ': 'Arizona',
    'AR': 'Arkansas',
  ...
  static String? getAbbr(String stateName) {
    return nameToAbbr[stateName];
  }
  ...
  static List<String> getAllStateNames() {
    return nameToAbbr.keys.toList()..sort();
  }

  /// Get all state abbreviations
  static List<String> getAllAbbreviations() {
    return abbrToName.keys.toList()..sort();
  }
}
